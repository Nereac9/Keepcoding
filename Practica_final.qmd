---
title: "Nerea Castañares Ramos Práctica Final"
format: html
editor: visual
---
...
```{r}
paste('El dataframe df_seeds tiene', ncol(df_seeds), 'columnas y', nrow(df_seeds), 'filas')
```
...
```{r}
kama_seeds <- df_seeds[df_seeds$tipo =='Kama',]
paste('La media del area del tipo Kama es',mean(kama_seeds$area))
rosa_seeds <- df_seeds[df_seeds$tipo == 'Rosa',]
paste('La media del area del tipo Rosa es ', mean(rosa_seeds$area))
canadian_seeds <- df_seeds[df_seeds$tipo == 'Canadian',]
paste('La media del area del tipo Canadian es ', mean(canadian_seeds$area))
```
...
**Respuesta**: 'Diagrama de cajas o boxplot. La línea del centro de cada caja representa la mediana.'
...
**Respuesta**: 'Debería usar un modelo de regresión logística.'
